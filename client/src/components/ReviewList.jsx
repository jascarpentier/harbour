    ...
    <>
      {props.reviews.map(review =>
        <div className="review" key={review.id}>
          ...
          {props.editingId === '' &&
            <button className='deleteReview' onClick={() =>
              props.handleDelete(review.id)}> Delete </button>}
          {props.editingId === '' &&
            <button className='updateReview' onClick={() =>
              props.handleUpdate(review.id)}> Update </button>}
          {props.updatingId === review.id &&
            (<form className='formthingy'>
              <input
                className="formthings"
                type="text"
                name="comment"
